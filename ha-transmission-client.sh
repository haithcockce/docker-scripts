...
ACTIVITY_LOG=/var/log/activity.log  # log for timing of specific actions
MESSAGES_LOG=/var/log/messages      # log for anytime the vpn starts/restarts
...
# Start the vpn
openvpn --config /etc/openvpn/AzireVPN-SE.ovpn --daemon --log /var/log/openvpn.log
